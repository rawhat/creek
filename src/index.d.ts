...
export declare function fromEvent<B extends EventTarget, T extends keyof EventMap<B> & string, E extends EventMap<B>[T]>(target: B, type: T): AsyncStream<E>;
declare class AsyncStream<T> {
    ...
    tap(effect: (value: T) => void): AsyncStream<T>;
...
declare class Stream<T> {
    ...
    tap(effect: (value: T) => void): Stream<T>;
