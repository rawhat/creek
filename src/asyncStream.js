  ...
  concat(other) {
    ...
    return new AsyncStream(function () {
      return __asyncGenerator(this, arguments, function* () {
        ...
        try {
          for (
            var other_1 = __asyncValues(other), other_1_1;
            (other_1_1 = yield __await(other_1.next())), !other_1_1.done;
  ...
  combine(...others) {
    ...
    const accumulator = {
      ...
      queue: promises.reduce(
        (acc, next, index) =>
          Object.assign(Object.assign({}, acc), { [index]: next }),
        {}
      ),
    };
    return index_1.unfoldAsync(accumulator, ({ generators, queue }) =>
      __awaiter(this, void 0, void 0, function* () {
  ...
  [Symbol.asyncIterator]() {
    ...
    return (function () {
      return __asyncGenerator(this, arguments, function* () {
        ...
        try {
          for (
            var _b = __asyncValues(self.generator()), _c;
